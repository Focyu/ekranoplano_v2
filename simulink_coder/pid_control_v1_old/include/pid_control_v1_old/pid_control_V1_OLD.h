...
struct B_pid_control_V1_OLD_T {
  ...
  real_T SignPreSat_h;                 /* '<S198>/SignPreSat' */
  real_T Sum5;                         /* '<Root>/Sum5' */
  real_T Gain1;                        /* '<Root>/Gain1' */
  real_T Square1;                      /* '<S10>/Square1' */
  real_T FE_b;
  real_T Mcg_b_idx_0;
  real_T FE2_b_idx_0;
  real_T FE2_b_idx_2;
...
struct DW_pid_control_V1_OLD_T {
  ...
  real_T PrevY_n;                      /* '<Root>/RL_phi_ref' */
  real_T LastMajorTime_o;              /* '<Root>/RL_phi_ref' */
  ...
  boolean_T PrevLimited_h;             /* '<Root>/RL_phi_ref' */
...
struct X_pid_control_V1_OLD_T {
  ...
  real_T Integrator_CSTATE_pm;         /* '<S260>/Integrator' */
...
struct XDis_pid_control_V1_OLD_T {
  ...
  boolean_T Integrator_CSTATE_pm;      /* '<S260>/Integrator' */
...
struct ConstB_pid_control_V1_OLD_T {
  ...
  real_T SignPreIntegrator;            /* '<S40>/SignPreIntegrator' */
  ...
  uint32_T PreLookUpIndexSearchprobo_g;
                        /* '<S305>/PreLook-Up Index Search  (prob of exceed)' */
  int8_T DataTypeConv2;                /* '<S40>/DataTypeConv2' */
};
 ...
 * '<S9>'   : 'pid_control_V1_OLD/PID_HEADING_RUDDER'
 ...
 * '<S226>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Anti-windup'
 * '<S227>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/D Gain'
 * '<S228>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/External Derivative'
 * '<S229>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Filter'
 * '<S230>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Filter ICs'
 * '<S231>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/I Gain'
 * '<S232>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Ideal P Gain'
 * '<S233>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Ideal P Gain Fdbk'
 * '<S234>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Integrator'
 * '<S235>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Integrator ICs'
 * '<S236>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/N Copy'
 * '<S237>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/N Gain'
 * '<S238>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/P Copy'
 * '<S239>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Parallel P Gain'
 * '<S240>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Reset Signal'
 * '<S241>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Saturation'
 * '<S242>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Saturation Fdbk'
 * '<S243>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Sum'
 * '<S244>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Sum Fdbk'
 * '<S245>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tracking Mode'
 * '<S246>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tracking Mode Sum'
 * '<S247>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tsamp - Integral'
 * '<S248>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tsamp - Ngain'
 * '<S249>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/postSat Signal'
 * '<S250>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/preInt Signal'
 * '<S251>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/preSat Signal'
 * '<S252>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Anti-windup/Passthrough'
 * '<S253>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/D Gain/Internal Parameters'
 * '<S254>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/External Derivative/Error'
 * '<S255>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Filter/Cont. Filter'
 * '<S256>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Filter ICs/Internal IC - Filter'
 * '<S257>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/I Gain/Internal Parameters'
 * '<S258>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Ideal P Gain/Passthrough'
 * '<S259>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Ideal P Gain Fdbk/Disabled'
 * '<S260>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Integrator/Continuous'
 * '<S261>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Integrator ICs/Internal IC'
 * '<S262>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/N Copy/Disabled'
 * '<S263>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/N Gain/Internal Parameters'
 * '<S264>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/P Copy/Disabled'
 * '<S265>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Parallel P Gain/Internal Parameters'
 * '<S266>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Reset Signal/Disabled'
 * '<S267>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Saturation/Passthrough'
 * '<S268>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Saturation Fdbk/Disabled'
 * '<S269>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Sum/Sum_PID'
 * '<S270>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Sum Fdbk/Disabled'
 * '<S271>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tracking Mode/Disabled'
 * '<S272>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tracking Mode Sum/Passthrough'
 * '<S273>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tsamp - Integral/TsSignalSpecification'
 * '<S274>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/Tsamp - Ngain/Passthrough'
 * '<S275>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/postSat Signal/Forward_Path'
 * '<S276>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/preInt Signal/Internal PreInt'
 * '<S277>' : 'pid_control_V1_OLD/PID_HEADING_RUDDER/preSat Signal/Forward_Path'
