...
void pid_control_V1_OLD::step()
{
  ...
  if (!(pid_control_V1_OLD_DW.LastMajorTime == (rtInf))) {
    pid_control_V1_OLD_B.SignPreSat = (&pid_control_V1_OLD_M)->Timing.t[0];
    pid_control_V1_OLD_B.Va = pid_control_V1_OLD_B.SignPreSat -
      pid_control_V1_OLD_DW.LastMajorTime;
    if (pid_control_V1_OLD_DW.LastMajorTime == pid_control_V1_OLD_B.SignPreSat)
    {
      ...
      pid_control_V1_OLD_B.Sum1_g = pid_control_V1_OLD_B.Va *
        0.26179938779914941;
      pid_control_V1_OLD_B.SignPreSat = pid_control_V1_OLD_B.RL_phi_ref -
        pid_control_V1_OLD_DW.PrevY;
      if (pid_control_V1_OLD_B.SignPreSat > pid_control_V1_OLD_B.Sum1_g) {
        /* Saturate: '<Root>/SAT_phi_ref' incorporates:
         *  RateLimiter: '<Root>/RL_phi_ref'
         */
        pid_control_V1_OLD_B.RL_phi_ref = pid_control_V1_OLD_DW.PrevY +
        ...
        if (pid_control_V1_OLD_B.SignPreSat < pid_control_V1_OLD_B.Va) {
          /* Saturate: '<Root>/SAT_phi_ref' incorporates:
           *  RateLimiter: '<Root>/RL_phi_ref'
           */
          pid_control_V1_OLD_B.RL_phi_ref = pid_control_V1_OLD_DW.PrevY +
   ...
   */
  pid_control_V1_OLD_B.SignPreSat_a = (-1.2 * pid_control_V1_OLD_B.Switch +
    pid_control_V1_OLD_X.Integrator_CSTATE_m) +
    pid_control_V1_OLD_B.FilterCoefficient_c;

  /* Saturate: '<S57>/Saturation' */
  if (pid_control_V1_OLD_B.SignPreSat_a > 0.17453292519943295) {
    /* Saturate: '<S57>/Saturation' */
    pid_control_V1_OLD_B.Saturation_k = 0.17453292519943295;
  } else if (pid_control_V1_OLD_B.SignPreSat_a < -0.17453292519943295) {
    /* Saturate: '<S57>/Saturation' */
    pid_control_V1_OLD_B.Saturation_k = -0.17453292519943295;
  } else {
    /* Saturate: '<S57>/Saturation' */
    pid_control_V1_OLD_B.Saturation_k = pid_control_V1_OLD_B.SignPreSat_a;
  }
  ...
  if (pid_control_V1_OLD_DW.LastMajorTime_j == (rtInf)) {
    ...
    if (pid_control_V1_OLD_DW.LastMajorTime_j == pid_control_V1_OLD_B.SignPreSat)
    {
      ...
      pid_control_V1_OLD_B.SignPreSat = pid_control_V1_OLD_B.Saturation_i -
   ...
   *  Sum: '<Root>/Sum3'
   */
  pid_control_V1_OLD_B.SignPreSat = ((20.2 - pid_control_V1_OLD_B.x[0]) * 0.08 +
    pid_control_V1_OLD_X.Integrator_CSTATE_f) +
    pid_control_V1_OLD_B.FilterCoefficient_cv;

  /* Saturate: '<S215>/Saturation' */
  if (pid_control_V1_OLD_B.SignPreSat > 1.0) {
    /* Saturate: '<S215>/Saturation' */
    pid_control_V1_OLD_B.Saturation_o = 1.0;
  } else if (pid_control_V1_OLD_B.SignPreSat < 0.0) {
    /* Saturate: '<S215>/Saturation' */
    pid_control_V1_OLD_B.Saturation_o = 0.0;
  } else {
    /* Saturate: '<S215>/Saturation' */
    pid_control_V1_OLD_B.Saturation_o = pid_control_V1_OLD_B.SignPreSat;
  }
  ...
  pid_control_V1_OLD_B.q_aero = (pid_control_V1_OLD_B.Memory1[2] +
    ...
    + -0.1146 * pid_control_V1_OLD_B.beta;
  ...
  /* Gain: '<S40>/ZeroGain' */
  pid_control_V1_OLD_B.beta = 0.0 * pid_control_V1_OLD_B.SignPreSat_a;

  /* DeadZone: '<S42>/DeadZone' */
  if (pid_control_V1_OLD_B.SignPreSat_a > 0.17453292519943295) {
    pid_control_V1_OLD_B.SignPreSat_a -= 0.17453292519943295;
  } else if (pid_control_V1_OLD_B.SignPreSat_a >= -0.17453292519943295) {
    pid_control_V1_OLD_B.SignPreSat_a = 0.0;
  } else {
    pid_control_V1_OLD_B.SignPreSat_a -= -0.17453292519943295;
  }
  ...
  if (rtIsNaN(pid_control_V1_OLD_B.SignPreSat_a)) {
    /* DataTypeConversion: '<S40>/DataTypeConv1' */
    i = 0;
  } else {
    if (pid_control_V1_OLD_B.SignPreSat_a < 0.0) {
      /* DataTypeConversion: '<S40>/DataTypeConv1' */
      pid_control_V1_OLD_B.w_r = -1.0;
    } else {
      /* DataTypeConversion: '<S40>/DataTypeConv1' */
      pid_control_V1_OLD_B.w_r = (pid_control_V1_OLD_B.SignPreSat_a > 0.0);
    }
  ...
  pid_control_V1_OLD_B.AND3 = ((pid_control_V1_OLD_B.beta !=
    pid_control_V1_OLD_B.SignPreSat_a) && (i == tmp_2));
  if (tmp_0) {
    /* Memory: '<S40>/Memory' */
  ...
  /* Gain: '<S198>/ZeroGain' */
  pid_control_V1_OLD_B.Sum2_l = 0.0 * pid_control_V1_OLD_B.SignPreSat;
  ...
  pid_control_V1_OLD_B.IntegralGain = 0.02 * pid_control_V1_OLD_B.Sum5;
  ...
  /* Unit Conversion - from: m/s to: ft/s
     Expression: output = (3.28084*input) + (0) */
  pid_control_V1_OLD_B.Sum2_l = 3.280839895013123 * pid_control_V1_OLD_B.Va;
  ...
  if (pid_control_V1_OLD_B.Sum5 > 1000.0) {
    ...
    pid_control_V1_OLD_B.Va = 1000.0;
  } else {
  ...
  pid_control_V1_OLD_B.SignPreSat = pid_control_V1_OLD_B.Sum_b / rt_powd_snf
    (0.000823 * pid_control_V1_OLD_B.Sum_b + 0.177, 1.2);

  /* Product: '<S306>/sigma_ug, sigma_vg' incorporates:
   *  Fcn: '<S306>/Low Altitude Intensity'
   */
  pid_control_V1_OLD_B.SignPreSat_a = 1.0 / rt_powd_snf(0.000823 *
    pid_control_V1_OLD_B.Va + 0.177, 0.4) * pid_control_V1_OLD_ConstB.sigma_wg;
  ...
  pid_control_V1_OLD_B.frac[0] = pid_control_V1_OLD_B.Va;
  ...
  pid_control_V1_OLD_B.Va = intrp2d_la_pw(pid_control_V1_OLD_B.bpIndex,
  ...
  if (pid_control_V1_OLD_DW.Hugws_MODE) {
    ...
    tmp_3 = _mm_mul_pd(_mm_loadu_pd(&pid_control_V1_OLD_X.ug_p_CSTATE[0]),
                       _mm_set_pd(pid_control_V1_OLD_B.Va,
      pid_control_V1_OLD_B.SignPreSat_a));
  ...
  if (pid_control_V1_OLD_DW.Hvgws_MODE) {
     ...
     *  Gain: '<S295>/Lv'
     */
    pid_control_V1_OLD_B.SignPreSat /= pid_control_V1_OLD_B.Sum2_l;
     ...
     *  Sum: '<S303>/Sum'
     */
    pid_control_V1_OLD_B.Sum1_g = (sqrt(0.31830988618379069 *
    ...
    pid_control_V1_OLD_B.w_g[0] = pid_control_V1_OLD_B.Sum1_g;
     ...
     *  Sum: '<S303>/Sum1'
     */
    pid_control_V1_OLD_B.w_e[0] = (pid_control_V1_OLD_B.Sum1_g *
    ...
    pid_control_V1_OLD_B.w_g[1] = pid_control_V1_OLD_B.Sum1_g;
     ...
     *  Sum: '<S303>/Sum1'
     */
    pid_control_V1_OLD_B.w_e[1] = (pid_control_V1_OLD_B.Sum1_g *
      pid_control_V1_OLD_B.SignPreSat * 1.7320508075688772 +
     ...
     *  Integrator: '<S303>/vgw_p2'
     */
    tmp_3 = _mm_mul_pd(_mm_set_pd(pid_control_V1_OLD_B.Va,
      pid_control_V1_OLD_B.SignPreSat_a), _mm_loadu_pd
  ...
  if (pid_control_V1_OLD_DW.Hwgws_MODE) {
     ...
     *  Gain: '<S295>/Lw'
     */
    pid_control_V1_OLD_B.SignPreSat_a = pid_control_V1_OLD_B.Sum_b /
      pid_control_V1_OLD_B.Sum2_l;
    ...
    pid_control_V1_OLD_B.SignPreSat = (sqrt(0.31830988618379069 *
      pid_control_V1_OLD_B.SignPreSat_a) * pid_control_V1_OLD_B.Product[2] -
      pid_control_V1_OLD_X.wg_p1_CSTATE[0]) / pid_control_V1_OLD_B.SignPreSat_a;
    ...
    pid_control_V1_OLD_B.w_a[0] = (pid_control_V1_OLD_B.SignPreSat *
      pid_control_V1_OLD_ConstB.sqrt_a * pid_control_V1_OLD_B.SignPreSat_a +
      (pid_control_V1_OLD_X.wg_p1_CSTATE[0] - pid_control_V1_OLD_X.wg_p2_CSTATE
       [0])) / pid_control_V1_OLD_B.SignPreSat_a;

    /* Product: '<S304>/Lwg//V' */
    pid_control_V1_OLD_B.SignPreSat_a = pid_control_V1_OLD_B.frac[1] /
      pid_control_V1_OLD_B.Sum2_l;
    ...
    pid_control_V1_OLD_B.SignPreSat = (sqrt(0.31830988618379069 *
      pid_control_V1_OLD_B.SignPreSat_a) * pid_control_V1_OLD_B.Product[2] -
      pid_control_V1_OLD_X.wg_p1_CSTATE[1]) / pid_control_V1_OLD_B.SignPreSat_a;
    ...
    pid_control_V1_OLD_B.w_a[1] = (pid_control_V1_OLD_B.SignPreSat *
      ...
      (pid_control_V1_OLD_X.wg_p1_CSTATE[1] - pid_control_V1_OLD_X.wg_p2_CSTATE
       [1])) / pid_control_V1_OLD_B.SignPreSat_a;
  ...
  pid_control_V1_OLD_B.SignPreSat_a = cos(pid_control_V1_OLD_B.x[6]);
  pid_control_V1_OLD_B.SignPreSat = sin(pid_control_V1_OLD_B.x[6]);
  pid_control_V1_OLD_B.Sum1_g = -sin(pid_control_V1_OLD_B.x[6]);
  pid_control_V1_OLD_B.Sum_hl = cos(pid_control_V1_OLD_B.x[6]);
  pid_control_V1_OLD_B.CD_ih_IGE = cos(pid_control_V1_OLD_B.x[7]);
  pid_control_V1_OLD_B.CQ = -sin(pid_control_V1_OLD_B.x[7]);
  pid_control_V1_OLD_B.w_r = sin(pid_control_V1_OLD_B.x[7]);
  ...
  pid_control_V1_OLD_B.w_r = (pid_control_V1_OLD_B.Ltot +
    pid_control_V1_OLD_B.Ltot_tmp) + pid_control_V1_OLD_B.w_r *
    pid_control_V1_OLD_B.Dtot_c;
  ...
  pid_control_V1_OLD_B.RotationAnglestoDirectionCo[0] =
    (pid_control_V1_OLD_B.CL_h_IGE * pid_control_V1_OLD_B.SignPreSat_a + 0.0 *
     pid_control_V1_OLD_B.Sum1_g) + pid_control_V1_OLD_B.Dtot_c;
  pid_control_V1_OLD_B.Ltot_tmp = pid_control_V1_OLD_B.hw * 0.0;
  pid_control_V1_OLD_B.RotationAnglestoDirectionCo[1] =
    (pid_control_V1_OLD_B.SignPreSat_a * pid_control_V1_OLD_B.CD_ih_IGE +
     pid_control_V1_OLD_B.Sum1_g * pid_control_V1_OLD_B.hh) +
  ...
  pid_control_V1_OLD_B.RotationAnglestoDirectionCo[2] =
    (pid_control_V1_OLD_B.SignPreSat_a * pid_control_V1_OLD_B.w_r +
     pid_control_V1_OLD_B.Sum1_g * pid_control_V1_OLD_B.CL_w_IGE) +
    pid_control_V1_OLD_B.Ltot;
  pid_control_V1_OLD_B.RotationAnglestoDirectionCo[3] =
    (pid_control_V1_OLD_B.CL_h_IGE * pid_control_V1_OLD_B.SignPreSat + 0.0 *
     pid_control_V1_OLD_B.Sum_hl) + pid_control_V1_OLD_B.Dtot_c;
  pid_control_V1_OLD_B.RotationAnglestoDirectionCo[4] =
    (pid_control_V1_OLD_B.SignPreSat * pid_control_V1_OLD_B.CD_ih_IGE +
     pid_control_V1_OLD_B.hh * pid_control_V1_OLD_B.Sum_hl) +
    pid_control_V1_OLD_B.Ltot_tmp;
  pid_control_V1_OLD_B.RotationAnglestoDirectionCo[5] =
    (pid_control_V1_OLD_B.SignPreSat * pid_control_V1_OLD_B.w_r +
     pid_control_V1_OLD_B.Sum_hl * pid_control_V1_OLD_B.CL_w_IGE) +
    pid_control_V1_OLD_B.Ltot;
  ...
  pid_control_V1_OLD_B.RotationAnglestoDirectionCo[8] =
    (pid_control_V1_OLD_B.w_r * 0.0 + pid_control_V1_OLD_B.CL_w_IGE * 0.0) +
    pid_control_V1_OLD_B.beta;
  ...
  switch (rtAction) {
   case 0:
     ...
     */
    pid_control_V1_OLD_B.SignPreSat_a = sin
    ...
    _mm_storeu_pd(&pid_control_V1_OLD_B.Product_m[0], _mm_add_pd(_mm_mul_pd
      (_mm_set_pd(pid_control_V1_OLD_B.SignPreSat_a, pid_control_V1_OLD_B.w1_c[0]),
      ...
      pid_control_V1_OLD_B.SignPreSat_a), _mm_set_pd
      (pid_control_V1_OLD_B.SignPreSat, pid_control_V1_OLD_B.w1[0])), _mm_set_pd
                 (1.0, -1.0))));
      ...
      tmp_3 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd
        ...
        (pid_control_V1_OLD_B.Product_m[i])), _mm_set_pd
                         (pid_control_V1_OLD_B.SignPreSat,
                          pid_control_V1_OLD_B.SignPreSat_a));
      _mm_storeu_pd(&pid_control_V1_OLD_B.dv1[0], tmp_3);
      pid_control_V1_OLD_B.SignPreSat_a = pid_control_V1_OLD_B.dv1[0];
    ...
    pid_control_V1_OLD_B.wbe_b[2] = pid_control_V1_OLD_B.Sum1_g;
    pid_control_V1_OLD_B.wbe_b[1] = pid_control_V1_OLD_B.SignPreSat;
    pid_control_V1_OLD_B.wbe_b[0] = pid_control_V1_OLD_B.SignPreSat_a;
   ...
   default:
    ...
    pid_control_V1_OLD_B.Product_m[2] = pid_control_V1_OLD_B.Sum1_g;
    pid_control_V1_OLD_B.Product_m[1] = pid_control_V1_OLD_B.SignPreSat;
    pid_control_V1_OLD_B.Product_m[0] = pid_control_V1_OLD_B.SignPreSat_a;
     ...
     */
    pid_control_V1_OLD_B.wbe_b[2] = (pid_control_V1_OLD_B.LwgV1[1] -
      pid_control_V1_OLD_B.Sum1_g) * (pid_control_V1_OLD_B.Sum5 - 1000.0) /
      pid_control_V1_OLD_ConstB.Sum + pid_control_V1_OLD_B.Sum1_g;
  ...
  if (pid_control_V1_OLD_DW.Hpgw_MODE) {
    /* Fcn: '<S299>/sqrt(0.8//V)' */
    pid_control_V1_OLD_B.w_r = sqrt(0.8 / pid_control_V1_OLD_B.Sum2_l);

    /* Product: '<S299>/w3' */
    pid_control_V1_OLD_B.SignPreSat_a = pid_control_V1_OLD_B.Sum2_l *
    ...
    pid_control_V1_OLD_B.w_o[0] = (pid_control_V1_OLD_B.w_r / rt_powd_snf
      ...
      pid_control_V1_OLD_X.pgw_p_CSTATE[0]) * pid_control_V1_OLD_B.SignPreSat_a;
  ...
  if (pid_control_V1_OLD_DW.Hqgw_MODE) {
     ...
     *  Sum: '<S300>/Sum'
     */
    pid_control_V1_OLD_B.Va = (pid_control_V1_OLD_B.LwgV1[0] /
    ...
    pid_control_V1_OLD_B.w_e0[0] = pid_control_V1_OLD_B.Va;

    /* UnaryMinus: '<S300>/Unary Minus' */
    pid_control_V1_OLD_B.UnaryMinus[0] = -pid_control_V1_OLD_B.Va;
     ...
     *  Sum: '<S300>/Sum'
     */
    pid_control_V1_OLD_B.Va = (pid_control_V1_OLD_B.LwgV1[1] /
      pid_control_V1_OLD_B.Sum2_l - pid_control_V1_OLD_X.qgw_p_CSTATE[1]) *
      (pid_control_V1_OLD_B.Sum_b / pid_control_V1_OLD_ConstB.UnitConversion_n);
    pid_control_V1_OLD_B.w_e0[1] = pid_control_V1_OLD_B.Va;

    /* UnaryMinus: '<S300>/Unary Minus' */
    pid_control_V1_OLD_B.UnaryMinus[1] = -pid_control_V1_OLD_B.Va;
  }
  ...
  switch (rtAction) {
   ...
   default:
    ...
    pid_control_V1_OLD_B.wbe_b[2] = (pid_control_V1_OLD_B.w_d[1] -
      pid_control_V1_OLD_B.Sum1_g) * (pid_control_V1_OLD_B.Sum5 - 1000.0) /
      pid_control_V1_OLD_ConstB.Sum_a + pid_control_V1_OLD_B.Sum1_g;
  ...
  if (tmp_0) {
    /* SignalConversion generated from: '<S10>/To Workspace1' incorporates:
    ...
    pid_control_V1_OLD_B.TmpSignalConversionAtSFunct[1] =
      pid_control_V1_OLD_B.Saturation_f;
    pid_control_V1_OLD_B.TmpSignalConversionAtSFunct[2] = 0.0;
    pid_control_V1_OLD_B.TmpSignalConversionAtSFunct[3] =
      pid_control_V1_OLD_B.Saturation_o;
    pid_control_V1_OLD_B.TmpSignalConversionAtSFunct[4] =
      pid_control_V1_OLD_B.Saturation_o;
...
void pid_control_V1_OLD::pid_control_V1_OLD_derivatives()
{
  ...
  _rtXdot->Integrator_CSTATE_p = pid_control_V1_OLD_B.IntegralGain;
